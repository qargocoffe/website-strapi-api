...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    Sustainability: Attribute.Text & Attribute.Required;
    Title_Meet_QargoCoffe: Attribute.String & Attribute.Required;
    Meet_Description_QargoCoffee: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
